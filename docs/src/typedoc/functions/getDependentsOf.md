[relizy](../globals.md) / getDependentsOf

# Function: getDependentsOf()

> **getDependentsOf**(`packageName`, `allPackages`): [`PackageWithDeps`](../interfaces/PackageWithDeps.md)[]

Defined in: [src/core/dependencies.ts:60](https://github.com/LouisMazel/relizy/blob/6094991aea4ffff9cbc685f08c1d8aa7cd9db591/src/core/dependencies.ts#L60)
